                ...
                (places)=>{
                    ...
                    for(x in this.places){
                        ...
                        if (this.places[x].train_no == newplace.train_no){
                            ...
                            this.places[x].location.lat = ((this.places[x].location.lat*this.places[x].count)+newplace.location.lat)/(this.places[x].count+1)
                            this.places[x].location.lng = ((this.places[x].location.lng*this.places[x].count)+newplace.location.lng)/(this.places[x].count+1)
